...
export function usage() {
    ...
    console.log(`localStorage usage calculated: ${totalBytes} bytes (${percentageUsed.toFixed(2)}% of capacity)`);
    ...
    fetch(defaultPath)
        ...
        .then(data => {
            if (data) {
                ...
                console.log("Defaults successfully fetched and stored in localStorage:", data);
            } else {
